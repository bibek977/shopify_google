export const footer_data = [
    {
        "foo" : "Start by entering your Google Business name, or domain in the search bar. The list of results based on your search will be displayed. Or connect your Google Business using Google Map URL. You can use Google Maps to find your Business."
    },
    {
